...
> Click on the link below in the desired AWS region to create the AWS Cloudformation stack which will create an Amazon VPC in your AWS account. This VPC will host the Amazon EFS file system and the other AWS resouces created as a part of this tutorial.
...
### Step 2: Create Amazon Virtual Private Cloud (Amazon VPC)
